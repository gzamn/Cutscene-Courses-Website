      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
          ...
          <button 
            ...
            className="flex items-center justify-center gap-2 py-3 px-4 bg-black border border-purple-900/30 rounded-2xl text-white hover:bg-zinc-900 transition-all font-medium"
          >
